...
export const btvConfig = {
  ...
  sections: {
    ...
    discover: {
      ...
      intro: 'Six movements — from noticing what is wrong, to knowing exactly what to do about it.',
    },
    ...
    launch: {
      ...
      registerIntro: "Free to attend. Reserve your place and we'll send the joining link.",
    ...
    purchase: {
      eyebrow: 'Purchase',
      title: 'Get Your Copy',
      intro: 'Choose the edition that suits you. Every purchase is handled by Spiritans Sound.',
  ...
  book: {
    ...
    description: [
      ...
      'It is a guide to recovering your own judgement, protecting your peace, and deciding — wisely, and without bitterness — what to do next.',
    ],
    themes: [
  ...
  author: {
    ...
    whyBody: [
      'I have sat with people at the moment the veil finally lifts — in parish ministry, in marriage preparation, in spiritual direction and counselling. Almost none of them were naive. Almost all of them said the same thing: "I knew something was wrong. I just could not prove it, so I talked myself out of it."',
      'I know that statement from the inside. I have suffered the brunt of deception myself. I have known the confusion of being told one thing while watching another, the slow erosion of self-trust that comes when you start to doubt what you saw with your own eyes. That is why this book is not written from a distance, as a theory — it is written from within the wound.',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Anyone navigating a relationship where something does not add up: spouses, engaged couples, families, friends, and those who counsel them.',
    },
    {
  ...
  videos: {
    ...
    intro: 'Short films, conversations and readings around Behind the Veil.',
    items: [
      {
        title: 'Book trailer',
  ...
  /* ------------------------------------------------------------------- seo */
  seo: {
    title: 'Behind the Veil: How to Detect Deception and Deal with Liars | Spiritans Sound',
    description:
