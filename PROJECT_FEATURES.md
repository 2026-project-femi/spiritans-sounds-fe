...
| Page             | Description                                                                    |
| ---------------- | ------------------------------------------------------------------------------ |
| Home             | Hero carousel, latest homily, articles, prayers, music highlights, FAQ section |
...
| Search           | Full-text search across homily, articles, and prayers                          |
...
- Comment submission form on homily, articles, and prayers
...
- Content types: homily, articles, prayers, music, events, magazines, books, radio, orders, donations, subscribers, contacts, pages
...
| **Standard** _(recommended)_ | ₦2,640,000              | Fair market rate for this complexity               |
...
_Document prepared: April 2026_
