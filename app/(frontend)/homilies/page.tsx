...
export const metadata: Metadata = {
	...
	description: "Explore our collection of homily and reflections on the Word of God.",
	openGraph: {
...
export default async function HomiliesPage({ searchParams }: HomiliesPageProps) {
	...
	const sidebarData = {
		categories: ["Sunday", "Weekday", "Feast Day"],
		recentPosts,
	};

	const homily = result.docs.map((doc: any) => ({
		...doc,
		_id: doc.id,
					...
					<div className="lg:col-span-8">
						<header className="text-center mb-12">
							...
							<p className="mt-4 text-lg text-muted-foreground">
								Explore our collection of homily and reflections on the Word of God.
							</p>
						</header>
						...
						{homily.length > 0 ? (
							...
							<p className="text-center text-muted-foreground">No homily found.</p>
						)}
					</div>
